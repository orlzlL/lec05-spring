...
public class LoggingAspect {
     ...
     *  포인트컷(pointcut)은 여러 조인 포인트들에 어드바이스(advice)를 적용할 곳으로 지정한 것이다.
     ...
     *    executive(* com.ohgiraffers.section01.advice.annotation..stu*(..))
     *    => com.ohgiraffers.section01.advice 패키지 및 하위 패키지에 속해 있고 이름이 stu로 시작하는 파라미터가 0개
     *       이상의 모든 메소드이며 접근제어자와 반환형은 상관 없음
     * */
...
//        System.out.println("After Advice 동작");
     ...
     *  심지어 원본 조인 포인트를 언제 실행할 지, 실행 자체를 안 할지, 계속 실행할지 여부까지도 제어한다.
     *  AroundAdvice의 조인포인트 매개변수는 ProceedeingJoingPoint로 고정되어 있다.
